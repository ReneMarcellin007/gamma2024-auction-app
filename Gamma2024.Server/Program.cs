...
builder.Services.AddControllers()
    .AddJsonOptions(options =>
    {
        ...
        // CORRECTION: Permettre les caractères spéciaux comme ! dans les JSON
...
builder.Services.AddAuthentication(options =>
{
    ...
    {
        var jwtKey = builder.Configuration["Jwt:Key"] ?? "UneCleSecuriseePourGamma2024QuiFaitAuMoins256Bits";
...
// SIMPLIFIED STARTUP - No DB initialization to prevent 502 errors
Console.WriteLine("🚀 APP BUILT SUCCESSFULLY - STARTING WITHOUT DB INIT TO AVOID 502");
Console.WriteLine("ℹ️  Use /api/emergencyseed/seed-now endpoint to initialize database");
Console.WriteLine("ℹ️  Use /api/test/check-db to verify database status");
Console.WriteLine("ℹ️  Database has already been seeded via SQL script - app should work!");
